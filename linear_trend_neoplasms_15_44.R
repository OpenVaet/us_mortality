# 15–44 death rates: recompute per 100,000, fit 2010–2019 trend, plot vs. 2020–2023 outcomes
...
in_path  <- "data/C00-D48 - 15-44 - 2010-to-2023.csv"
out_img  <- "visual/c00d48_15-44_rates_trend.png"

# ---------- Load & recompute rate for total 15–44 ----------
raw <- read_csv(in_path, show_col_types = FALSE)

# Sum deaths/population across 15–24, 25–34, 35–44 -> total 15–44
rates <- raw %>%
  mutate(
...
ggsave("visual/c00d48_15-44_rates_trend.png", p, width = 11.5, height = 6.8, dpi = 300)
p
