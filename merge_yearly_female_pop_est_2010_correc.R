...
# 2000–2009 single-year-of-age (Year,Age,Population) - assumes that get_alt_2010_female_data.R has been executed first.
pop_2000_2009 <- read_csv("data/us_intercensal_female_2000_2010_single_year.csv",
...
# helper: keep SEX==2, pivot POPESTIMATE columns to Year/Population
to_long <- function(df) {
  df %>%
...
# write output
write_csv(merged, "data/merged_yearly_female_population_by_age_2010_correction.csv")
