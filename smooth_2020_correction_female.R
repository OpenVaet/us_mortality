...
# --- Load original data ---
pop_raw <- read_csv("data/merged_yearly_female_population_by_age_2010_correction.csv",
...
output_file <- "data/merged_yearly_female_population_by_age_2020_smoothed.csv"
pop_smoothed %>%
  arrange(Year, Age) %>%
...
ggsave("visual/female_cohort_deltas_comparison.png", p1, width = 12, height = 8, dpi = 150)
...
ggsave("visual/female_adjustment_heatmap.png", p2, width = 10, height = 8, dpi = 150)
cat("Heatmap saved to visual/female_adjustment_heatmap.png\n")
