...
ggsave(file.path(OUT_DIR, paste0("cohort_5y_groups_base_pop_plus_delta_", year_span, "_wide16x8.pdf")),
       p5, width = 16, height = 8, units = "in", bg = "white")
ggsave(file.path(OUT_DIR, paste0("cohort_5y_groups_base_pop_plus_delta_", year_span, "_wide16x8.png")),
